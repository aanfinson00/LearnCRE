...
export const assetManager: Cert = {
  ...
  modules: [
    ...
    {
      id: 'am-m5-asset-class',
      title: 'Asset-class-specific math',
      description:
        'The math that only shows up in one sector: hotel RevPAR + GOP, office WALT + renewal economics, retail occupancy-cost ratios, industrial truck density + clear height, multifamily loss-to-lease.',
      benchmarks: [
        {
          id: 'am-m5-hotel-quiz',
          kind: 'quizAccuracy',
          label: 'Hotel + Office quiz',
          kindSet: [
            'revparFromAdrOcc',
            'gopMargin',
            'ffeReserveDollars',
        ...
        {
          id: 'am-m5-retail-industrial-quiz',
          kind: 'quizAccuracy',
          label: 'Retail + Industrial + MF quiz',
          kindSet: [
            'salesPerSf',
            'occupancyCostRatio',
        ...
        },
        {
          id: 'am-m5-walk-hotel',
          kind: 'walkthroughComplete',
          label: 'Hotel RevPAR-to-Value walkthrough',
          walkId: 'walk-hotel-revpar-1',
          minStepAccuracyPct: 0.8,
        },
        {
          id: 'am-m5-walk-office',
          kind: 'walkthroughComplete',
          label: 'Office WALT + NER walkthrough',
          walkId: 'walk-office-walt-1',
          minStepAccuracyPct: 0.8,
        },
      ],
    },
